...
public class TRN_Generator : MonoBehaviour
{
    ...
    public void Generate()
    {
        ...
        var genTerrainData = new TerrainData
        {
            name = terrain.terrainData.name,
            hideFlags = terrain.terrainData.hideFlags,
            ...
            detailPrototypes = terrain.terrainData.detailPrototypes,
            treeInstances = terrain.terrainData.treeInstances,
            treePrototypes = terrain.terrainData.treePrototypes,
            enableHolesTextureCompression = terrain.terrainData.enableHolesTextureCompression,
        ...
        terrain.terrainData = genTerrainData;
        ...
        var planarPosition = new Vector2(transform.position.x, transform.position.z);
        const float sampleScale = 1 / WorldWrapNoiseSize;
